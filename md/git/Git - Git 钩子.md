> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [git-scm.com](https://git-scm.com/book/zh/v2/%E8%87%AA%E5%AE%9A%E4%B9%89-Git-Git-%E9%92%A9%E5%AD%90)
...
<table><tbody><tr><td><p>Note</p></td><td><p>需要注意的是，克隆某个版本库时，它的客户端钩子 <strong>并不</strong> 随同复制。 如果需要靠这些脚本来强制维持某种策略，建议你在服务器端实现这一功能。 （请参照 <a href="https://git-scm.com/book/zh/v2/ch00/_an_example_git_enforced_policy">使用强制策略的一个例子</a> 中的例子。）</p></td></tr></tbody></table>
