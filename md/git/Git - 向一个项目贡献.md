> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [git-scm.com](https://git-scm.com/book/zh/v2/%E5%88%86%E5%B8%83%E5%BC%8F-Git-%E5%90%91%E4%B8%80%E4%B8%AA%E9%A1%B9%E7%9B%AE%E8%B4%A1%E7%8C%AE)
...
![](https://git-scm.com/book/en/v2/images/git-diff-check.png)
...
<table><tbody><tr><td><p>Note</p></td><td><p>按我们说的去做，不要照着我们做的去做。</p><p>为简单起见，本书中很多例子的提交说明并没有遵循这样良好的格式， 我们只是对 <code>git commit</code> 使用了 <code>-m</code> 选项。</p><p>简而言之，按我们说的去做，不要照着我们做的去做。</p></td></tr></tbody></table>
...
![](https://git-scm.com/book/en/v2/images/small-team-1.png)
...
![](https://git-scm.com/book/en/v2/images/small-team-2.png)
...
![](https://git-scm.com/book/en/v2/images/small-team-3.png)
...
![](https://git-scm.com/book/en/v2/images/managed-team-1.png)
...
这称作一个 _引用规范_。 查看 [引用规范](https://git-scm.com/book/zh/v2/ch00/_refspec) 了解关于 Git 引用规范与通过它们可以做的不同的事情的详细讨论。 也要注意 `-u` 标记；这是 `--set-upstream` 的简写，该标记会为之后轻松地推送与拉取配置分支。
...
![](https://git-scm.com/book/en/v2/images/managed-team-2.png)
...
<table><tbody><tr><td><p>Note</p></td><td><p>你可以用 <code>rebase -i</code> 将工作压缩成一个单独的提交，或者重排提交中的工作使补丁更容易被维护者审核—— 查看 <a href="https://git-scm.com/book/zh/v2/ch00/_rewriting_history">重写历史</a> 了解关于交互式变基的更多信息。</p></td></tr></tbody></table>
...
![](https://git-scm.com/book/en/v2/images/public-small-3.png)
